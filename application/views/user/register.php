                ...
                <div id="login" class="tab-pane active">
                    <form class="form-signin" id="login_box" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <input type="number" placeholder="Postal Code" class="form-control" name="pincode" onkeypress="return isNumeric(event)" oninput="maxLengthCheck(this)" maxlength = "5" required value="<?php echo set_value('pincode'); ?>"> </div>
                            <div class="col-lg-6">
