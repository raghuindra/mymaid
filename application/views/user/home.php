...
<div class="overlay">
        <div class="topNav">
            ...
            <div class="logo-section">MyMaid</div>
        </div>
        <!-- PAGE CONTENT -->
                      ...
                      <div class="table-outer">
                        <div class="table-inner">
                          <div class="div-inline">
                            ...
                            <div class="col-lg-4">
                                <div class="row"><input type="text" placeholder="Enter your postal code" class="form-control" name="" id=""></div> </div>
                                <div class="col-lg-2">
                                <div class="row"><button type="button" placeholder="Find" class="form-control btn-success">Find </button> </div></div>
                          </div>
                        </div>
                      </div>
                    </div>
      ...
      <div class="reviews">
        <div class="outer-table">
          <div class="inner-table">
            <div class="content">was extremely easy to use and I usually book a cleaning when I'm commuting, using the app. And, my cleaner is fantastic! She always makes sure my house is left sparking clean! I am sold and will definitely book Helpling again!</div>
            <img src="<?php echo img_url('cleaner.png') ?>" alt="text" />
          </div>
        </div>
      </div>
...
<div class="modal fade" id="login-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        ...
        <form class="form-signin" id="login_box">
            ...
            <input type="text" placeholder="Email id" class="form-control" name="" id="">
            <input type="password" placeholder="Password" class="form-control" name="" id="">
            <hr>
            <div class="row">
                <div class="col-lg-4">
