                                ...
                                <div class="form-horizontal">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" id="icnumber" name="icnumber" placeholder="IC Number">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 control-label">House Phone:</label>
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" id="phone" name="phone" placeholder="House Phone">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 control-label">H/P Phone:</label>
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" id="hpphone" name="hphone" placeholder="H/P Phone">
                                            </div>
                                        </div>
                                        <div class="form-group">
