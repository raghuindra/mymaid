        ...
        <div class="row">
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-aqua">
                    ...
                    <a href="<?php echo base_url().'vendor_newjobs.html';?>" class="small-box-footer">More info <i class="fa fa-shopping-cart"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-green">
                    ...
                    <a href="<?php echo base_url().'vendor_activejobs.html';?>" class="small-box-footer">More info <i class="fa fa-hourglass-end"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-yellow">
                    ...
                    <a href="<?php echo base_url().'vendor_completedjobs.html';?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-red">
                    ...
                    <a href="<?php echo base_url().'vendor_wallet_request.html';?>" class="small-box-footer">More info <i class="fa fa-money"></i></a>
                </div>
            </div>
            <!-- ./col -->
        </div>
            ...
            <section class="col-lg-12 connectedSortable">
                ...
                <div class="nav-tabs-custom">
                    ...
                    <ul class="nav nav-tabs pull-right">
                        <li class="active hidden"><a href="#revenue-chart" data-toggle="tab">Area</a></li>
                        <li class="hidden"><a href="#sales-chart" data-toggle="tab">Donut</a></li>
                        <li class="pull-left header"><i class="fa fa-inbox"></i> Service</li>
                    </ul>
                ...
                <div class="box box-success hidden">
                    ...
                    <div class="box-body chat" id="chat-box">
                        <!-- chat item -->
                        <div class="item">
                            <img src="<?php echo plugin_url('dist/img/user4-128x128.jpg');?>" alt="user image" class="online">
                        ...
                        <!-- chat item -->
                        <div class="item">
                            <img src="<?php echo plugin_url('dist/img/user3-128x128.jpg');?>" alt="user image" class="offline">
                        ...
                        <!-- chat item -->
                        <div class="item">
                            <img src="<?php echo plugin_url('dist/img/user2-160x160.jpg');?>" alt="user image" class="offline">
            ...
            <section class="col-lg-12 connectedSortable">
                ...
                <div class="box box-solid bg-green-gradient hidden">
                    ...
                    <div class="box-footer text-black">
                        ...
                        <div class="progress xs">
                            <div class="progress-bar progress-bar-green" style <div class="progress-bar progress-bar-green" style="width: 70%;"></div>
                            </div>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
