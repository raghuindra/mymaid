...
<header class="main-header">
    ...
    <a href="<?php echo base_url().'admin_home.html' ?>" class="logo">
        ...
        <span class="logo-mini"><b>A </b>MyMaidZ</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Super Admin </b>MyMaidZ</span>
    </a>
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                        ...
                        <li>
                            ...
                            <ul class="menu">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="<?php echo plugin_url('dist/img/user3-128x128.jpg');?>" class="img-circle" alt="User Image">
                                        </div>
                                        <h4>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="<?php echo plugin_url('dist/img/user4-128x128.jpg');?>" class="img-circle" alt="User Image">
                                        </div>
                                        <h4>
                                            Developers
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<?php echo plugin_url('dist/img/avatar5.png');?>" class="user-image" alt="User Image">
