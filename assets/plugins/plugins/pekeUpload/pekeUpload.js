        ...
        var pekeUpload = {
            ...
            handlebuttonevents: function() {
                ...
                $(document).on('click','.pkdel',function(){
                    ...
                    getUploadFileInputId($(this).parentsUntil('.form-group').find('input[type=file]').attr('id'));
            ...
            addRow: function(file) {
                ...
                switch (options.bootstrap) {
                  case true:
                    ...
                    var finfo = $('<div class="col-lg-7 col-md-8 col-xs-8"></div>').appendTo(newRow);
                    ...
                    var dismiss = $('<div class="col-lg-3 col-md-2 col-xs-2"></div>').appendTo(newRow);
